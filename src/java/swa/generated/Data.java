...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Data other) {
    ...
    lastComparison = Boolean.valueOf(is_set_pedigree()).compareTo(typedOther.is_set_pedigree());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_dataunit()).compareTo(typedOther.is_set_dataunit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_dataunit()) {
