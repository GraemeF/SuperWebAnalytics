...
public class Location implements org.apache.thrift.TBase<Location, Location._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Location other) {
    ...
    lastComparison = Boolean.valueOf(is_set_city()).compareTo(typedOther.is_set_city());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_state()).compareTo(typedOther.is_set_state());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_state()) {
    ...
    lastComparison = Boolean.valueOf(is_set_country()).compareTo(typedOther.is_set_country());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_country()) {
