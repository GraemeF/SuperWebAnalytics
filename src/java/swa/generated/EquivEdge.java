...
public class EquivEdge implements org.apache.thrift.TBase<EquivEdge, EquivEdge._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_id1);
    if (present_id1)
      builder.append(id1);

    boolean present_id2 = true && (is_set_id2());
    builder.append(present_id2);
    if (present_id2)
      builder.append(id2);
  ...
  public int compareTo(EquivEdge other) {
    ...
    lastComparison = Boolean.valueOf(is_set_id1()).compareTo(typedOther.is_set_id1());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_id2()).compareTo(typedOther.is_set_id2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_id2()) {
